...
df = pd.DataFrame(data=numpy_data['df_name_as_saved_in_npy_file'], columns=columns)
...
#sum of values in a column, grouped by another column without using the column as an index
